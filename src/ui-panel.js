// ui-panel.js — v4.2.0: CSS-token dark mode, no inline colour painting
...
GH.buildPanel = function () {
    ...
    versionBar.textContent = 'D2L Grading Helper v4.2.0';
    ...
    function refreshFeedbackList() {
        ...
        list.forEach((text, idx) => {
            ...
            editBtn.addEventListener('click', () => { const u=window.prompt('Edit feedback:',list[idx]); if(u!==null&&u.trim()){list[idx]=u.trim();GH.saveConfig();refreshFeedbackList();updatePreview();} });
