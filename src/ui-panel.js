...
GH.buildPanel = function () {
    ...
    Object.assign(versionBar.style, { fontSize: '10px', color: 'var(--gh-text-faint)', textAlign: 'center', paddingTop: '2px', paddingBottom: '2px', letterSpacing: '0.03em' });
    versionBar.textContent = 'D2L Grading Helper v4.0.0';
